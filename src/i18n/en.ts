...
const en = {
  ...
  captures: {
    ...
    add_to_rules_filter_placeholder: "Name or tag:label",
    add_to_rules_filter_title:
      "Substring over the collection's name and its tags. tag:label narrows to tags, tag:a,b matches either.",
    ...
    new_collection_hint: "{{count}} rules will be created in it",
    new_collection_tags_label: "Collection tags",
    new_collection_create: "Create",
  ...
  rules: {
    ...
    tag_suggestions: "already in use:",
    tag_filter_title: "Show everything tagged \"{{tag}}\"",
    tag_collection_title: "Collection tags",
    tags_note:
      "Labels for finding rules later — the engine never reads them, so a tag can never be why a mock did or didn't fire. Filter with tag:name. A collection's tags also match its rules.",
    delete: "Delete",
    delete_title: "Delete",
    ...
    collapse: "Collapse",
    expand_all: "Expand all",
    expand_all_title: "Expand every collection",
    collapse_all: "Collapse all",
    collapse_all_title: "Collapse every collection",
    tree_view_title: "Switch to tree view",
    flat_view_title: "Switch to list view",
    tree_empty_selection: "Select a collection or rule",
    tree_add_rule_title: "New rule here",
    tree_tag_title: "Tag",
    tree_export_title: "Export",
    tree_rename_title: "Rename",
    tree_rename_disabled_title: "Rename it in the editor below",
    tree_delete_title: "Delete",
    tree_no_actions_title: "Ungrouped has no actions of its own",
    tree_select_all_title: "Select all in this collection",
