...
const en = {
  ...
  rules: {
    ...
    ungrouped: "Ungrouped",
    filter_placeholder: "Filter by rule name, collection, or the request it matches",
    filter_help:
      "Substring match, case-insensitive. Several words = all of them must match. Searches the rule name, its collection name, and the request (method, host, path, query params). Escape clears.",
