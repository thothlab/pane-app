...
const ru: Dict = {
  ...
  logcat: {
    ...
    search_title:
      "Подсвечивает совпадающую подстроку во всех видимых колонках (время, приложение, тег, сообщение). Enter — к следующему совпадению, Shift+Enter — к предыдущему. Список НЕ сужает — это задача фильтра. Регистронезависимо.",
