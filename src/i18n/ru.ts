...
const ru: Dict = {
  ...
  captures: {
    ...
    add_to_rules_filter_placeholder: "Название или tag:метка",
    add_to_rules_filter_title:
      "Подстрока по названию коллекции и её тегам. tag:метка сужает поиск до тегов, tag:a,b - любой из двух.",
    ...
    new_collection_tags_label: "Теги коллекции",
  ...
  rules: {
    ...
    filter_help:
      "Подстрока, без учёта регистра. Несколько слов - должны совпасть все. Ищет по названию правила, названию его коллекции, по тегам и по запросу (метод, хост, путь, query-параметры).\ntag:имя сужает поиск до тегов - пригодится, когда то же слово есть и в названии правила.\nЗапятая внутри термина - ИЛИ: tag:smoke,ios найдёт помеченные любым из двух, пробел между терминами остаётся И.\nТеги коллекции матчатся и на её правила. Escape очищает.",
    ...
    tag_suggestions: "уже используются:",
    tag_filter_title: "Показать всё с тегом \"{{tag}}\"",
    tag_collection_title: "Теги коллекции",
    tags_note:
      "Метки, чтобы потом найти правило. Движок их не читает, поэтому тег никогда не бывает причиной, сработала заглушка или нет. Фильтр - tag:имя. Теги коллекции матчатся и на её правила.",
    delete: "Удалить",
    ...
    device_this_mac: "Этот Mac",
    device_plane_title: "Выбрать, от лица какого устройства читается и правится список",
    device_banner:
        "Показано то, что работает на {name}. Галки меняют только это устройство; правила с пометкой ALL работают везде.",
    device_ios_note: "iOS делит общий порт прокси, отдельный скоуп для него невозможен",
    badge_scoped: "{count} уст.",
    badge_scoped_title:
        "Закреплено за {count} устройством(ами). Устройство, подключённое позже, это правило не получит — включите его на плане «Все устройства», чтобы снова стало общим.",
    copy_suffix: " - копия",
    ...
    expand_all_title: "Развернуть все коллекции",
    collapse_all: "Свернуть все",
    collapse_all_title: "Свернуть все коллекции",
    tree_view_title: "Переключить на дерево",
    flat_view_title: "Переключить на список",
    tree_empty_selection: "Выберите коллекцию или правило",
    tree_add_rule_title: "Новое правило здесь",
    tree_tag_title: "Теги",
    tree_export_title: "Экспорт",
    tree_rename_title: "Переименовать",
    tree_rename_disabled_title: "Переименуйте в редакторе ниже",
    tree_delete_title: "Удалить",
    tree_no_actions_title: "У Ungrouped нет собственных действий",
    tree_select_all_title: "Выбрать все в этой коллекции",
