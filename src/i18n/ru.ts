...
const ru: Dict = {
  ...
  settings: {
    ...
    poll_seconds: "с",
    poll_hint:
      "Во время автопрогона (Maestro на эмуляторе) окно никто не смотрит, а каждый опрос - нагрузка на тот же бэкенд, который использует прогон: тут уместно реже или совсем выключить. Когда вы смотрите трафик руками, разумнее 1-2 секунды.",
