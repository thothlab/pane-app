...
fn ca_payload(ca_pem: &str) -> String {
    ...
    format!(
        r#"  <dict>
    <key>PayloadCertificateFileName</key><string>pane-root.crt</string>
    <key>PayloadContent</key>
    <data>
{der_b64}
    </data>
    <key>PayloadDescription</key><string>Pane root CA</string>
    <key>PayloadDisplayName</key><string>Pane CA</string>
    <key>PayloadIdentifier</key><string>tech.thothlab.pane.ca.{uuid}</string>
...
fn proxy_payload(host: &str, port: u16) -> String {
    ...
    <key>PayloadIdentifier</key><string>tech.thothlab.pane.proxy.{uuid}</string>
    <key>PayloadUUID</key><string>{uuid}</string>
    <key>PayloadDisplayName</key><string>Pane proxy</string>
    <key>PayloadDescription</key><string>Routes device traffic through Pane</string>
    <key>PayloadVersion</key><integer>1</integer>
...
{body}
  ...
  <key>PayloadDescription</key><string>Pane HTTPS inspection profile</string>
  <key>PayloadDisplayName</key><string>Pane</string>
  <key>PayloadIdentifier</key><string>tech.thothlab.pane.profile.{top_uuid}</string>
  <key>PayloadOrganization</key><string>Pane</string>
